...
@click.argument("environment", type=click.Choice(EnvironmentType.values()), required=False)
@click.pass_context
def env(ctx: click.Context, environment: str):
    ...
    if environment:
        ...
        current_env = config_manager.get_config("environment", EnvironmentType.DEVELOPMENT.value)
