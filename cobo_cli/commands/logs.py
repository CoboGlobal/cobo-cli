...
from cobo_cli.utils.api import make_request, load_api_spec
...
@click.pass_context
def tail(ctx: click.Context, http_method: str, request_path: str, status_code: str, api_key: str, ip_address: str):
    ...
    click.echo(f"Listening for api logs")
...
def print_log_detail(log_detail):
    ...
    click.echo(click.style("Log ID:", fg="yellow") + f" {log_detail['api_request_uuid']}")
